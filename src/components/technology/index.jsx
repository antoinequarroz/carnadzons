                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="content_technology" data-aos="fade-up" data-aos-duration="800">
                                    ...
                                    <p>Amis aventuriers de l'espace, bienvenue au Carna'dzons de Saint-Martin, sous le thème 'Les Modzons sur la Lune' ! Rejoignez-nous pour une journée où nous explorons les confins de l'univers. L'espace, un domaine d'audace et de mystère, inspire nos costumes scintillants de symboles lunaires et stellaires, évoquant des astronautes et des voyageurs interstellaires.
                                        Les rues se transforment en galaxies lointaines, avec des chars décorés comme des vaisseaux spatiaux. La musique, un mélange de rythmes terrestres et de sons cosmiques, invite à une danse interstellaire.
                                        Cette aventure spatiale symbolise notre désir de liberté, de découverte et d'unité.
                                        Vivez cette expérience unique le 4 février 2024 à Saint-Martin, où le carnaval devient une odyssée spatiale, unissant la communauté dans un voyage à travers les étoiles.</p>
